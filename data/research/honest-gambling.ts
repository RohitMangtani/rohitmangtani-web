...
export const honestGamblingData: ResearchData = {
  ...
  subtitle: 'Transparent risk preferences in speculative markets',
...
<p>In extractive systems, whether failed startup tokens, opaque financial products, or gated investment structures, loss is obscured. Participants discover the rules only after losing: vesting schedules they didn't understand, information asymmetries they couldn't see.</p>
<p>Given a choice between legible risk and illegible extraction, many choose legibility. Losing in a game you understood feels different from losing in a game you were deceived about.</p>`,
        },
        {
          ...
          content: `<p>Permissionless systems offer something rare: the appearance of an equal starting line. When anyone can participate from the moment a token launches (no accreditation, no waitlist, no insider allocation), the game feels, if not fair, at least <em>uniformly unfair</em>.</p>
<p>Contrast this with systems where the best opportunities are reserved for insiders or accredited investors. By the time retail participants arrive, the game has often already been played.</p>
...
<p>Participants may protect psychological dignity by choosing games where loss is not accompanied by the sense of having been deceived. This is not rational in expected-value terms. It may be rational in broader terms.</p>`,
    ...
    },
    {
      id: 'the-contrast',
      title: 'The Contrast',
      content: `<p>The distinction that matters is not between "meme coins" and "serious investments." It is between two structures:</p>
...
<p>Both are negative-sum for most participants. But the first is honest about it.</p>`,
    },
    {
      ...
      content: `<p>This analysis does not claim that meme coin participants are smarter, more informed, or more likely to profit. They are not.</p>
...
<p>It claims only that the preference is explicable: under under conditions of perceived unfairness, distrust, and constrained access, participants may rationally choose honest gambling over dishonest alternatives.</p>`,
    },
    {
      ...
      content: `<p>If this analysis is correct, the popularity of transparent coordination games is not primarily about greed, stupidity, or crypto enthusiasm. It is a symptom of something else: a perception that traditional systems are extractive, opaque, or closed.</p>
<p>Participants are not choosing meme coins because they believe meme coins are good. They are choosing meme coins because they believe the alternatives are worse, or at least, worse in ways that feel more degrading.</p>
