...
export const theHumanYieldData: ResearchData = {
  ...
  onRamp: {
    ...
    whatItDoes: 'Describes the structural conditions that make passive participation economically rational, and connects it to existing patterns in idle games, passive investing, and spectator economics.',
  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        ...
        <p>These games have millions of players. They are not a joke. They are not ironic. People genuinely find them satisfying. And the reason is structural, not psychological.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>In each case, the human is not performing the core function. The human is performing the function of being human. That is the job. The labor is existence within a system that still requires — legally, socially, structurally — a human presence.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          <li><strong class="text-[var(--fg)]">Community assets:</strong> Groups creating their own economic instruments — tokens, communities, mutual aid structures — that operate outside the traditional system. The value is not financial returns. The value is belonging to something that does not require you to be economically productive in the traditional sense.</li>
    ...
    },
    {
      ...
      content: `
        ...
        <div class="p-5 border border-[var(--border)] rounded-lg bg-[var(--bg-secondary)] my-6">
          <p class="text-sm text-[var(--fg-muted)]">The spectator class we described in <a href="/writing/the-gameable-society" class="underline hover:opacity-60">The Gameable Society</a> was a preview. People who watched optimization content instead of optimizing. People fluent in the language of improvement but structurally prevented from acting on it.</p>
          <p class="text-sm text-[var(--fg-muted)] mt-3">That class is about to expand dramatically. Not because people choose spectatorship. Because the system is choosing it for them. When AI can do your job better than you can, watching becomes the rational allocation of your time. The spectator class was voluntary. The proxy class is structural.</p>
        </div>

        <p>The game does not stop. It restructures. The humans who were players become supervisors. The humans who were supervisors become spectators. The humans who were spectators become background noise — present, counted, compensated at the floor, but not required.</p>
