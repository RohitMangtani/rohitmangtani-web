...
<p>The GitHub path is straightforward now. Install Claude Code and/or Codex, run the setup script, log into Vercel once, then run <code>npm run launch</code>. Hive leaves the terminals on your machine and gives you your own hosted dashboard, which is why I can check it from my phone without changing how the agents work.</p>
